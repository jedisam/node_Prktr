      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            url = type === 'password' ? 'http://localhost:7000/api/v1/users/updateMyPassword' : 'http://localhost:7000/api/v1/users/updateMe';
            _context.next = 6;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 10:
            ...
            console.log('err', _context.t0.response);
            (0, _alert.showAlert)('error', _context.t0.response.data.message);
...
var stripe = Stripe('pk_test_51HAaK4FoQBS8aejMfhu7tog4u9oDWOYGzmlDKbvmHwLV4DxfASFuMyvD32zwsFxoLjoyPsR231H2FEYL7nWc218d00mnAtVVOU');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:7000/api/v1/bookings/checkout-session/".concat(tourId));
